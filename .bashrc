...
# alias ll='ls -l'                              # long list, sorted
...
#                     user color, host color,  dir color,  text color
# PS1='\[\e]0;\w\a\]\n\[\e[31m\]savant\[\e[31m\]@hp \[\e[34m\]\w\[\e[0m\]\n$ '
...
# PS1='\em[savant@\h \W  '
#         0 is for term-title,      34-green, 7-reversed, 0m - foreground-color
# PS1="\[\e]0;Terminal \w\a\]\n\[\e[34;7m\]\w\[\e[0m\]\[\e[35m\]\$(parse_git_branch)\[\e[0m\] "

PS1="\[\e]0;Terminal \w\a\]\n\[\e[34m\]\w\[\e[0;35m\]$(parse_git_branch)\[\e[0m\]\[\e[32m\]\n$ "
