# Generated by Powerlevel10k configuration wizard on 2021-07-20 at 23:41 IST.
...
() {
  ...
  function my_git_formatter() {
    ...
    #   res+="${clean}${(g::)POWERLEVEL9K_VCS_BRANCH_ICON}${branch//\%/%%}"
      res+="%F{magenta}${(g::)POWERLEVEL9K_VCS_BRANCH_ICON}${branch//\%/%%}"
    fi
    ...
    if [[ -n ${VCS_STATUS_REMOTE_BRANCH:#$VCS_STATUS_LOCAL_BRANCH} ]]; then
      res+="${meta}:%F{cyan}${(V)VCS_STATUS_REMOTE_BRANCH//\%/%%}"
    fi
...
#   typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%n@%m'
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%B%F{123}[ %F{105}savant%F{97} \UF17A %F{134}windows%F{123} ]'
